    ...
    <>
      <section className="section section-lead home-hero" id="sin">
        <div className="wrap">
          ...
          <h1 className="display home-title">
            Practice the tower exam.
            <br />
            Use it on the lift.
          </h1>
          <p className="lede mt">
            Tower and self-erect Red Seal practice. Rigging, procedures, forms
            and binders. Written for operators, riggers and supervisors in
            British Columbia.
          </p>
          <div className="home-jobs">
            <div className="home-practice">
              ...
              <Link href="/sling" title="Sling angle, tension and WLL desk">
                <strong className="display">Rigging</strong>
                <em>θ · tension · WLL</em>
              </Link>
            </div>
      ...
      <section className="section wrap" id="safety">
        ...
        <p className="lede mt">
          ...
          procedures, JHAs and tower and self-erect binders. Readable on a
